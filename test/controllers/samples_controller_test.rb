...
class SamplesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sample" do
    assert_difference('Sample.count') do
      post samples_url, params: { sample: { data: @sample.data, topic: @sample.topic, uuid: @sample.uuid } }
    end
  ...
  test "should update sample" do
    patch sample_url(@sample), params: { sample: { data: @sample.data, topic: @sample.topic, uuid: @sample.uuid } }
